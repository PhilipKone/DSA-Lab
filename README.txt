Project Title: Vaccine and Medical Supply Distribution Optimization

Description:
This project provides two dynamic programming solutions to optimize the distribution of resources in healthcare settings:
...
test_script.txt: Sample test script for running both functions with sample data. Also available in .m format (vaccineDistributionMain, medicalSupplyMain medicalSupplyDP_tests.m).

Usage Instructions:
Load the function files (vaccineDistributionDP.m and medicalSupplyDP.m) in your MATLAB environment.
Open and run test_script.txt or the .m files directly to see example outputs for each function with sample data.
...
Detailed pseudocode is available within pseudocode.txt file to guide future implementations in other programming languages.
Project Repository: All code files are available on GitHub for additional reference and updates. 
[GitHub Repository Link: https://github.com/PhilipKone/DSA-Lab.git]